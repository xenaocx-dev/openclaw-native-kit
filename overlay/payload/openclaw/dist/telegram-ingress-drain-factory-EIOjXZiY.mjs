...
function createTelegramSpooledHandlerTimeoutAbortReason(params) {
	const updateId = Number(params.eventId);
	return Object.assign(new Error(params.message), {
		code: TELEGRAM_SPOOLED_HANDLER_TIMEOUT_ABORT_CODE,
		eventId: params.eventId,
		laneKey: params.laneKey,
		...Number.isSafeInteger(updateId) ? { updateId } : {}
	});
}
